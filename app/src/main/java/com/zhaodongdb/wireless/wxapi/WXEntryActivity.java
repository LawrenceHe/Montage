...
import com.zhaodongdb.common.utils.WXNetworkUtil;
...
//						wxEntryActivityWeakReference.get().startActivity(intent);
	...
	public void onResp(BaseResp resp) {
		...
		if (resp.getType() == ConstantsAPI.COMMAND_SENDAUTH) {
			...
			WXNetworkUtil.sendWxAPI(handler, String.format("https://api.weixin.qq.com/sns/oauth2/access_token?" +
							"appid=%s&secret=%s&code=%s&grant_type=authorization_code", WXConstants.APP_ID,
					WXConstants.APP_SECRET, code), WXNetworkUtil.GET_TOKEN);
		}
        finish();
	}
